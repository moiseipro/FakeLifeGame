...
namespace MalbersAnimations
{
    ...
    public class ActionZone : MonoBehaviour, IWayPoint
    {
        ...
        {
            if (other.gameObject.layer != 20) return;                               //if is not an Animal Skip
            ...
            if (animal_Colliders == null) animal_Colliders = new List<Collider>();  //Check all the colliders that enters the Action Zone Trigger
        ...
        IEnumerator CheckForCollidersOff() //??
        {
            ...
            if (animal_Colliders != null && animal_Colliders.Count>0 && animal_Colliders[0].enabled == false)
            {
