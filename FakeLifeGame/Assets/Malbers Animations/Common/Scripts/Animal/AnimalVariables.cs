...
namespace MalbersAnimations
{
    ...
    public partial class Animal
    {
        ...
        /// <summary>
        /// Current Smothness Value use on Jump and Fall Behaviour
        /// </summary>
        ...
        public virtual bool MovementReleased
        {
            private set
            {
                if (movementReleased != value)
                {
                   ...
                   // if (AnimState != Hash.Action && !Action) SetIntID(value ? -2 : 0); //Send to the animator that the Movement was released by setting it to (-2) or to (0) if it wasn't;
                }
            }
