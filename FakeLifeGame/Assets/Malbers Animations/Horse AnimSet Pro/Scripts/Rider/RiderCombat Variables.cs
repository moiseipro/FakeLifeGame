...
namespace MalbersAnimations.HAP
{
    ...
    public partial class RiderCombat
    {
        ...
        public InputRow InputAttack1 = new InputRow("Fire1", KeyCode.Mouse0, InputButton.Press);            //Input for Attack1 
        public InputRow InputAttack2 = new InputRow("Fire2", KeyCode.Mouse1, InputButton.Press);            //Input for Attack2
        public InputRow InputAim     = new InputRow("Fire2", KeyCode.Mouse1, InputButton.Press);            //Input for AIM
        ...
        public InputRow Reload = new InputRow("Reload","Reload", KeyCode.R, InputButton.Down, InputType.Key);   //Input to get the Weapons in the Right Holder if using Holders
